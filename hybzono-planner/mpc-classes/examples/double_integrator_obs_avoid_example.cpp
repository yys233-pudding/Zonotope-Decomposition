...
int main()
{
    ...
    get_map_zonotope_tiling(x_range, y_range, X_hz, A_Hrep, b_Hrep);
    //get_map(X_hz, A_Hrep, b_Hrep);
    ...
    mpc.setup_hybzono_Hrep_constraints(X_hz, A_Hrep, b_Hrep, Pc.sparseView(), Q_hz.sparseView());
